...
نکته: در حلقه‌ی این کد اندیس آرایه از ۰ شروع می‌شود ولی من `index + 1` را چاپ کرده‌ام. پس عددی که در خروجی و در اسکرین‌شات‌ها می‌بینید یک واحد بیشتر از شماره‌ی واقعی فراخوانی سیستمی است، چون در x86-64 شماره‌ها از ۰ شروع می‌شوند. آدرس‌ها درست هستند و فقط همین شماره جابه‌جاست.
