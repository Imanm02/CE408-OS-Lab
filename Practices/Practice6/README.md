...
- [x]  Getting started with memory segments
    ...
    - [x] نکته: این دو تصویر در گزارش اصلی یکی هستند و در واقع فقط یکی از دو خروجی خواسته‌شده ثبت شده است.
